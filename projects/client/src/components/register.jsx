...
export default function Register() {
  ...
  useEffect(() => {
    let { fullname, email, password, phoneNumber, gender, birtdate } =
      formik.values;
    if (
      !fullname ||
      !email ||
            ...
            <FormControl id="birthDate" isRequired>
              <InputGroup>
                <InputLeftElement
                  pointerEvents="none"
                  children={
                    <Icon as={BsCalendarWeek} color="gray.500" boxSize={5} />
                  }
                />
                <Input
                  type="date"
                  ...
                  onChange={(e) =>
                    formik.setFieldValue("birtdate", e.target.value)
                  }
                />
              </InputGroup>
              <FormHelperText color="black">
                <Flex gap={2}>
                  <Icon
                    ...
                    color="red"
                    boxSize={5}
                    display={formik.errors.birtdate ? null : "none"}
                  />
              ...
              <Flex justifyContent={"center"}>
                ...
                <LoginSocialFacebook
                  ...
                  onResolve={async (response) => {
                    ...
                    const addUserFB = await axiosInstance.post(
                      "/api/auth/v2",
                      userFacebook
                    );
                    ...
                    if (addUserFB.status === 200) {
                      toast({
                        title: "Account created.",
                        description:
                          "Anda berhasil registrasi melalui Facebook Account",
                        status: "success",
                        duration: 4000,
                        isClosable: true,
                      });
