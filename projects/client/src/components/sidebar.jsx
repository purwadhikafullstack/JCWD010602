...
export default function Sidebar(){
    return(
        <>
        <Flex w="390px" bgColor={"#B8D2FC"} minH="100vh" alignItems={"center"} flexDir="column">
            ...
            <Link paddingBottom={"50px"} fontSize="14" fontFamily={"Roboto"} fontWeight="bold">My Properties</Link>
